package com.example.topicpreview.data

import com.example.topicpreview.R
...
class Datasource {
    ...
    fun loadTopic() : List<Topic> {
        return  listOf(
            ...
            Topic(R.string.automotive, 30, R.drawable.automative),
...
/**
 * We can also define the DataSource as object. By defining this as object, the calling object is just
 * like Datasource.topic
 *
 * object DataSource {
 *     val topics = listOf(
 *         Topic(R.string.architecture, 58, R.drawable.architecture),
